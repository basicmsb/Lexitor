...
class Project(Base, TimestampMixin):
    """Workspace unutar organizacije. Jedna Organization može imati N
    workspace-ova (npr. odvojeni workspaces za različite klijente). U MVP-u
    je obično 1:1 — pri registraciji nove Organization, kreira se default
    Project istog imena."""
    ...
    organization_id: Mapped[uuid.UUID | None] = mapped_column(
        ...
        nullable=True,  # nullable za migration period; sljedeća migracija → NOT NULL
        index=True,
    )
